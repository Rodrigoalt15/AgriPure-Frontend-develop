<template>
  <div class="toolbar-container">
    <div class="toolbar">
      ...
      <button
        @click="selectedTab = 'plants'"
        :class="selectedTab === 'plants' ? 'selected' : ''"
      >
        Plants
      </button>
      <button
        @click="selectedTab = 'calendar'"
        :class="selectedTab === 'calendar' ? 'selected' : ''"
      >
        Calendar
      </button>
      <button
        @click="selectedTab = 'plots'"
        :class="selectedTab === 'plots' ? 'selected' : ''"
      >
        Plots
      </button>
      <button
        @click="selectedTab = 'plotsView'"
        :class="selectedTab === 'plotsView' ? 'selected' : ''"
      >
        Plots Manage
      </button>
      <button
        @click="selectedTab = 'forecast'"
        :class="selectedTab === 'forecast' ? 'selected' : ''"
      >
        Forecast
      </button>
      <button
        @click="selectedTab = 'professional'"
        :class="selectedTab === 'professional' ? 'selected' : ''"
      >
        Professional
      </button>
    </div>
...
import PlotsViewComponent from "@/plots/components/plotsView.component.vue";
export default {
  ...
  components: {
    ...
    "plotsView-component": PlotsViewComponent,
  },
  data() {
    return {
      selectedTab: "plants",
