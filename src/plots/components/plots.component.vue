...
<template>
  <div class="card text-center">
    ...
    <div class="card flex justify-content-center bgBody">
      <Image src="@/assets/plot.png" alt="Image" width="800" />
    </div>
  </div>
      ...
      <div class="card">
        <div class="formgrid grid">
          <div class="field col text-center bg-green">
            <img
              src="@/assets/caulifo.png"
              class="imgCaulifo mt-3 col-fixed"
              alt=""
            />
            <div class="col-fixed">
          ...
          <div class="field col">
            ...
            <div class="text-center pt-2">
              ...
              ></InputText>
              <div
                class="card flex justify-content-center button-content my-3 mx-auto"
              >
                <Button
                  type="button"
                  severity="success"
